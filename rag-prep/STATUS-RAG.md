...
**Dernière mise à jour :** 22 mai 2026 (S2.5 Lot S2.5.0-bis livré — H2 dédiée Obligations réglementaires pr-07)
**Sprint en cours :** **S2.5 en cours** — Lots A + S2.5.0 + E mergés (PR #74). Lot Drer Desktop livré (3/4 — q-030 ❌ patch lead insuffisant). **Lot S2.5.0-bis ✅** : option (a) Blaise validée, nouvelle section H2 dédiée « Obligations réglementaires IA pour un projet en PME 2026 » dans pr-07 (540 mots / ~700 tokens, lead bridge fort vocabulaire q-030 — RGPD art. 22 + AI Act art. 14 + Moffatt + conformité sectorielle). pr-07 v3.11.1 → v3.11.2. Pattern Lot D-ter + AP-7 SPEC v1.8 strictement appliqués. **RETOUR-SONDAGE-COWORK-HUB-IA-S2.5 reçu** (sondage global 8 modules vague 5, 2 rectifications critiques CU-024 PA = Plateforme Agréée ≠ Portail public + DEP-01 6 étapes = arbre décision technique ≠ cadrage projet, 4 passages bonus). Reste : re-rerun Lot Drer bis Desktop sur q-030 (~0,12 $) pour validation puis Lot F.5 production 8 modules vague 5 + G/H/I/J.
