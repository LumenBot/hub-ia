...
**Dernière mise à jour :** 25 mai 2026 (S2.7 Lot Dev fix — calibration v2 harness adversarial, re-scoring 12/12)
**Correctif harness adversarial ✅** (Plateforme, branche `claude/execute-s27-lot-dev-fix-adversarial`) : calibration v2 STRONG/WEAK markers (phrase canonique system prompt ajoutée + marqueur franc prime sur citations), **re-scoring offline 12/12 refus corrects** (vs 0/12 faux négatif Lot I), 206/206 tests verts, 0 $. Robustesse RAG confirmée EXCELLENTE (96/96 std + 12/12 adv) → **le score parfait S2.6 n'était pas de l'overfit**. Reste : Lot J RAPPORT-CC-S2.7 + PR finale.
