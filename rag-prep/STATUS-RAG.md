...
**Dernière mise à jour :** 19 mai 2026 (S2.4 Phase 3 Lot I livré — eval 52q score 50/52 = 96 %)
**Sprint en cours :** **S2.4 en cours, Phase 3 — Lot I livré** : eval extended 52q score global **50/52 (96 %)**, sources 50/52, concepts ≥ 50 % couverts 44/52 (85 %), latence moyenne 16,5 s/q, coût 1,28 $ Anthropic (cap 1,35 $ respecté). **10/10 nouvelles q-043 → q-052 score=1** (pattern-persistent-memory, refactor CU-008/DEP-02, Frontier Firms CU-026, Stanford CU-027, SBOM IA DEP-08, nouveau PR-08). 2 régressions S2.3 identifiées : q-002 (cu-001 rang #8) et q-030 (top-9 saturé par pr-08) — effet de bord ajout pr-08 sur questions génériques « projet IA 2026 PME ». Reste **Lot J (Plateforme)** : RAPPORT-CC-S2.4 + PR finale. Lot F.5 (8 modules whitelistés) reporté S2.5 dédié.
