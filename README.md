...
- 🧱 **11 préalables** — qu'est-ce que je dois maîtriser avant de me lancer ? (`prealables.html`)
...
├── prealables.html         ← index des 11 préalables
├── prealables/             ← une page par préalable (pr-01 à pr-11)
...
├── ressources.html         ← catalogue d'outils (104 fiches en 16 catégories)
